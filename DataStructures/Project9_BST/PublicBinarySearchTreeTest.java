...
public class PublicBinarySearchTreeTest {
	...
	private BSTInterface<Integer> bigTree;
	...
	public void before() {
		...
		oneNodeTree.add(FOO);
		int[] big = new int[] {50, 55, 40, 54, 57, 56, 58, 36, 30, 31, 37, 45, 44, 43, 42, 46};
	...
	public void testHeight() {
		...
		System.out.print(BinarySearchTree.toDotFormat(bigTree.getRoot()));
		assertEquals(5, bigTree.height());
	}
